...
import { Home, Library, Store, Compass, Clock, Settings } from "lucide-react";

interface BottomNavProps {
  activeTab: "home" | "library" | "store" | "explore" | "history" | "settings";
  onChangeTab: (tab: "home" | "library" | "store" | "explore" | "history" | "settings") => void;
}
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-14 max-w-lg items-center justify-around px-1.5 sm:px-2">
        ...
        {/* Library Tab (Personal Bookshelf & Progress) */}
        <button
          id="nav-tab-library"
          type="button"
