...
import { Home, Store, Compass, Clock, Settings } from "lucide-react";

interface BottomNavProps {
  activeTab: "home" | "store" | "explore" | "history" | "settings";
  onChangeTab: (tab: "home" | "store" | "explore" | "history" | "settings") => void;
}
    ...
    >
      <div className="mx-auto flex h-14 max-w-lg items-center justify-around px-2">
        ...
        >
          ...
          <span className="text-[11px] leading-none">Store</span>
        </button>
